...
class FancyButton:
    ...
    def on_release(self, event):
        if self.is_mouse_within_bounds(event.x_root, y_root):
            self.command()
...
class FancyButtonTestApp:
    ...
    def create_taskmanager_surface(self, parent):
        ...
        self.taskmanager_fb_cpu_font10 = ttk.Label(parent, text="CPU:  0%", style="cleanFrameButtonText.TLabel", anchor="w")
        self.taskmanager_fb_cpu_font10.pack(fill=tk.X, padx=10, pady=(0, 0))
        self.taskmanager_fb_ram_font10 = ttk.Label(parent, text="RAM:  0%", style="cleanFrameButtonText.TLabel", anchor="w")
        self.taskmanager_fb_ram_font10.pack(fill=tk.X, padx=10, pady=0)
        self.taskmanager_fb_disk_font10 = ttk.Label(parent, text="DISK: 0%", style="cleanFrameButtonText.TLabel", anchor="w")
        self.taskmanager_fb_disk_font10.pack(fill=tk.X, padx=10, pady=0)
        self.taskmanager_fb_up_font10 = ttk.Label(parent, text="UP:   0 MB", style="cleanFrameButtonText.TLabel", anchor="w")
        self.taskmanager_fb_up_font10.pack(fill=tk.X, padx=10, pady=0)
        self.taskmanager_fb_down_font10 = ttk.Label(parent, text="DOWN: 0 MB", style="cleanFrameButtonText.TLabel", anchor="w")
        self.taskmanager_fb_down_font10.pack(fill=tk.X, padx=10, pady=(0, 2))
    ...
    def create_spinbox_surface(self, parent):
        ...
        self.spinbox_fb_font10 = ttk.Label(parent, text="Font Size 6", anchor="center", style="cleanFrameButton.TLabel")
    ...
    def create_radiobutton_surface(self, parent):
        ...
        self.radiobutton_fb_option1_font10 = ttk.Radiobutton(parent, text="Option 1", variable=radio_var, value="Option 1")
        self.radiobutton_fb_option1_font10.pack(fill=tk.X, padx=5, pady=5)
        self.radiobutton_fb_option2_font10 = ttk.Radiobutton(parent, text="Option 2", variable=radio_var, value="Option 2")
        self.radiobutton_fb_option2_font10.pack(fill=tk.X, padx=5, pady=5)
        self.radiobutton_fb_font10 = ttk.Label(parent, text="Font Size 6", anchor="center", style="cleanFrameButton.TLabel")
    ...
    def create_scale_surface(self, parent):
        ...
        self.scale_fb_font10 = ttk.Label(parent, text="Font Size 6", anchor="center", style="cleanFrameButton.TLabel")
    ...
    def create_listbox_surface(self, parent):
        ...
        self.listbox_fb_font10 = ttk.Label(parent, text="Font Size 6", anchor="center", style="cleanFrameButton.TLabel")
    ...
    def create_canvas_surface(self, parent):
        ...
        self.canvas_fb_font10 = ttk.Label(parent, text="Font Size 6", anchor="center", style="cleanFrameButton.TLabel")
    ...
    def create_progressbar_surface(self, parent):
        ...
        self.progressbar_fb_font10 = ttk.Label(parent, text="Font Size 6", anchor="center", style="cleanFrameButton.TLabel")
