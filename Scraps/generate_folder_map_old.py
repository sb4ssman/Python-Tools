...
Drop this script into any project folder and run it to generate a folder structure map.
The output will use the actual project folder name dynamically.
"""
...
def main():
    ...
    # Create output content - use dynamic project name
    output = []
