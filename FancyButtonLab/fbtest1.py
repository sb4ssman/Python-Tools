...
class FancyButton:
    ...
    def bind_children(self, widget):
        ...
        widget.bind("<Button-1>", self.on_click_child)
        widget.bind("<ButtonRelease-1>", self.on_release_child)
    ...
    def on_click_child(self, event):
        if not isinstance(event.widget, (ttk.Spinbox, ttk.Checkbutton, ttk.Radiobutton, ttk.Scrollbar)):
            self.update_style("Click")
    ...
    def update_style(self, state):
        ...
        for widget in self.surface.winfo_children():
            ...
            if isinstance(widget, (ttk.Checkbutton, ttk.Radiobutton)):
                widget.config(style=f"{theme}FrameButton.TLabel")
...
class FancyButtonTestApp:
    ...
    def create_taskmanager_surface(self, parent):
        self.taskmanager_title_font8 = ttk.Label(parent, text="Task Manager_font8", anchor="center", style="cleanFrameButton.TLabel")
        ...
        self.cpu_label_font6 = ttk.Label(parent, text="CPU:  0%_font6", style="cleanFrameButtonText.TLabel", anchor="w")
        self.cpu_label_font6.pack(fill=tk.X, padx=10, pady=(0, 0))
        self.ram_label_font6 = ttk.Label(parent, text="RAM:  0%_font6", style="cleanFrameButtonText.TLabel", anchor="w")
        self.ram_label_font6.pack(fill=tk.X, padx=10, pady=0)
        self.disk_label_font6 = ttk.Label(parent, text="DISK: 0%_font6", style="cleanFrameButtonText.TLabel", anchor="w")
        self.disk_label_font6.pack(fill=tk.X, padx=10, pady=0)
        self.up_label_font6 = ttk.Label(parent, text="UP:   0 MB_font6", style="cleanFrameButtonText.TLabel", anchor="w")
        self.up_label_font6.pack(fill=tk.X, padx=10, pady=0)
        self.down_label_font6 = ttk.Label(parent, text="DOWN: 0 MB_font6", style="cleanFrameButtonText.TLabel", anchor="w")
        self.down_label_font6.pack(fill=tk.X, padx=10, pady=(0, 2))

    def create_prompt_surface(self, parent):
        self.prompt_title_font10 = ttk.Label(parent, text="Prompt Chooser_font10", anchor="center", style="cleanFrameButton.TLabel")
        ...
        self.prompt_button_title_font12 = ttk.Label(parent, text="Prompt_font12", anchor="center", style="cleanFrameButton.TLabel")
        self.prompt_button_title_font12.pack(fill=tk.BOTH, padx=5, pady=5, ipady=5)

    def create_mouse_tracker_surface(self, parent):
        self.mouse_label_heading_font10 = ttk.Label(parent, text="Mouse Tracker_font10", style="cleanFrameButton.TLabel", anchor="center", width=12)
        ...
        x_w = 0 - offsetX
        y_w = 0 - offsetY
        self.mouse_label_body_font8 = ttk.Label(parent, text=f"Pixel:          (0, 0)_font8\nWindows:  ({x_w}, {y_w})_font8", anchor="w")
        self.mouse_label_body_font8.pack(fill=tk.X, padx=10, pady=2)
        self.toggle_mouse_button_title_font12 = ttk.Label(parent, text="Start Tracking_font12", anchor="center", style="cleanFrameButton.TLabel")
        self.toggle_mouse_button_title_font12.pack(fill=tk.BOTH, padx=5, pady=5, ipady=5)

    def create_spinbox_surface(self, parent):
        self.spinbox_title_font8 = ttk.Label(parent, text="Spinbox_font8", anchor="center", style="cleanFrameButton.TLabel")
        ...
        self.spinbox_font6 = ttk.Label(parent, text="Font Size 6_font6", anchor="center", style="cleanFrameButton.TLabel")
        self.spinbox_font6.pack(fill=tk.X, padx=5, pady=(2, 0))

    def create_radiobutton_surface(self, parent):
        self.radiobutton_title_font10 = ttk.Label(parent, text="Radiobutton_font10", anchor="center", style="cleanFrameButton.TLabel")
        ...
        self.radiobutton_font6 = ttk.Label(parent, text="Font Size 6_font6", anchor="center", style="cleanFrameButton.TLabel")
        self.radiobutton_font6.pack(fill=tk.X, padx=5, pady=(2, 0))

    def create_scale_surface(self, parent):
        self.scale_title_font8 = ttk.Label(parent, text="Scale_font8", anchor="center", style="cleanFrameButton.TLabel")
        ...
        self.scale_font6 = ttk.Label(parent, text="Font Size 6_font6", anchor="center", style="cleanFrameButton.TLabel")
        self.scale_font6.pack(fill=tk.X, padx=5, pady=(2, 0))

    def create_listbox_surface(self, parent):
        self.listbox_title_font10 = ttk.Label(parent, text="Listbox_font10", anchor="center", style="cleanFrameButton.TLabel")
        self.listbox_title_font10.pack(fill=tk.X, padx=5, pady=(2, 0))
        self.listbox_frame = tk.Frame(parent)
        self.listbox_frame.pack(fill=tk.X, padx=5, pady=5)
        self.listbox = tk.Listbox(self.listbox_frame, width=10, height=5)
        ...
        self.listbox_font6 = ttk.Label(parent, text="Font Size 6_font6", anchor="center", style="cleanFrameButton.TLabel")
        self.listbox_font6.pack(fill=tk.X, padx=5, pady=(2, 0))

    def create_canvas_surface(self, parent):
        self.canvas_title_font12 = ttk.Label(parent, text="Canvas_font12", anchor="center", style="cleanFrameButton.TLabel")
        ...
        self.canvas_font6 = ttk.Label(parent, text="Font Size 6_font6", anchor="center", style="cleanFrameButton.TLabel")
        self.canvas_font6.pack(fill=tk.X, padx=5, pady=(2, 0))

    def create_progressbar_surface(self, parent):
        self.progressbar_title_font8 = ttk.Label(parent, text="Progressbar_font8", anchor="center", style="cleanFrameButton.TLabel")
        ...
        self.progressbar_font6 = ttk.Label(parent, text="Font Size 6_font6", anchor="center", style="cleanFrameButton.TLabel")
