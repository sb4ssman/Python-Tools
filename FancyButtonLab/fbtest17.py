...
# Checkboxes and radio buttons need to have their backgrounds respond to hover and click events with the same background colors as the labels. 

# ttk.Frames on surfaces also need to have their backgrounds react the same way.

# Blank area inside the fancybutton frames should be clickable to activate the command. 
