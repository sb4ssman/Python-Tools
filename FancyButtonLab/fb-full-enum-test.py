# REDESIGN:
    # fully enumerated functions for each widget, tk, and ttk
...
class FancyButton:
    ...
    def update_style(self, state):
        ...
        self.style_descendants(self.surface, bg_color, fg_color, state, theme, mode, colors)
    ...
    def style_tk_canvas(self, widget, bg_color, theme, mode):
        widget.configure(
            background=bg_color,
            borderwidth=0,
            closeenough=1.0,
    ...
    def style_widget(self, widget, bg_color, fg_color, theme, mode):
        ...
        if widget_type == "Label":
            ...
            self.style_tk_canvas(widget, bg_color, theme, mode)
    ...
    def style_descendants(self, widget, bg_color, fg_color, state, theme, mode, colors):
        for child in widget.winfo_children():
            self.style_widget(child, bg_color, fg_color, theme, mode)
            if hasattr(child, 'winfo_children'):
                self.style_descendants(child, bg_color, fg_color, state, theme, mode, colors)
