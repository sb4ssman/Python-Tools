...
from FancyButtonStyleLibrary2 import LIGHT_COLORS, DARK_COLORS, FancyButtonStyleLibrary
...
class FancyButton:
    ...
    def update_style(self, state):
        ...
        self.style_library.style_widget(self.surface, bg_color, fg_color, theme, mode)
        self.style_descendants(self.surface, bg_color, fg_color, theme, mode)

    # def style_descendants(self, widget, bg_color, fg_color, theme, mode):
    #     for child in widget.winfo_children():
    #         self.style_library.style_widget(child, bg_color, fg_color, theme, mode)
    #         if hasattr(child, 'winfo_children'):
    #             self.style_descendants(child, bg_color, fg_color, theme, mode)
    ...
    def style_descendants(self, widget, bg_color, fg_color, theme, mode):
        for child in widget.winfo_children():
            if isinstance(child, tk.Frame):
                ...
                self.style_library.style_ttk_frame(child, bg_color, theme, mode)
            else:
                self.style_library.style_widget(child, bg_color, fg_color, theme, mode)
