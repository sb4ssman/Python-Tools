...
class FancyButton:
    ...
    def update_style(self, state):
        ...
        fg_color = colors.get('text_color', 'white' if mode == 'dark' else 'black')
        ...
        self.style_descendants(self.surface, bg_color, fg_color)

    def style_descendants(self, widget, bg_color, fg_color):
        for child in widget.winfo_children():
            ...
            if isinstance(child, (tk.Frame, ttk.Frame)) or hasattr(child, 'winfo_children'):
                self.style_descendants(child, bg_color, fg_color)
...
class FancyButtonTestApp:
    ...
    def update_app_style(self):
        ...
        self.toolbox_frame.configure(style='Toolbox.TFrame')
        self.toggle_theme_button.configure(style='TButton')
